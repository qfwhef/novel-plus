...
public enum ErrorCodeEnum {
     ...
     * 用户手机号已存在
     */
    USER_PHONE_EXIST("A0110", "用户手机号已存在"),

    /**
     * 两次密码不一致
     */
    USER_PASSWORD_NOT_MATCH("A0113", "两次密码不一致"),
     ...
     * 用户状态异常
     */
    USER_STATUS_ERROR("A0220", "用户状态异常"),
     ...
     * 操作过于频繁
     */
    USER_REQUEST_FREQUENT("A0502", "操作过于频繁，请稍后重试"),
     ...
     * 评论不存在
     */
    USER_COMMENT_NOT_EXIST("A2002", "评论不存在"),

    /**
     * 评论内容过短
     */
    USER_COMMENT_CONTENT_TOO_SHORT("A2003", "评论内容不能少于2个字符"),

    /**
     * 评论内容过长
     */
    USER_COMMENT_CONTENT_TOO_LONG("A2004", "评论内容不能超过512个字符"),

    /**
     * 已经点赞
     */
    COMMENT_ALREADY_LIKED("A2005", "您已经点赞过该评论"),

    /**
     * 未点赞
     */
    COMMENT_NOT_LIKED("A2006", "您还未点赞该评论"),
     ...
     * 小说删除异常
     */
    AUTHOR_BOOK_NOT_EXIST("A3002", "小说不存在"),
     ...
     * 小说已在书架中
     */
    USER_BOOK_SHELF_EXIST("A0302", "小说已在书架中"),

    /**
     * 小说不在书架中
     */
    USER_BOOK_SHELF_NOT_EXIST("A0303", "小说不在书架中"),
