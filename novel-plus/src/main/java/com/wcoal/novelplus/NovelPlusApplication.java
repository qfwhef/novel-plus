...
@MapperScan("com.wcoal.novelplus.dao.mapper")
@EnableCaching
@Slf4j
public class NovelPlusApplication {

    public static void main(String[] args) {
        SpringApplication.run(NovelPlusApplication.class, args);
    }
