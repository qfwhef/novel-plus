...
import { setToken, setNickName, setUserName, setUid } from "@/utils/auth";
...
export default {
  ...
  setup() {
    ...
    const loginUser = async () => {
      ...
      // 验证手机号格式（如果需要的话，这里可以根据实际需求调整）
      // if (!/^1[3-9]\d{9}$/.test(state.userName)) {
      //   ElMessage.error("手机号格式不正确！");
      //   return; // 这里必须要有 return
      // }
