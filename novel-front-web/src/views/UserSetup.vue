        ...
        <div class="my_info cf">
          <div class="my_info_txt">
            <ul class="mytab_list">
              <li>
                <i class="tit">我的头像</i>
                <el-upload class="avatar-uploader" :http-request="customUpload" :show-file-list="false"
                  :before-upload="beforeAvatarUpload">
                  <img :src="getUserImageUrl(userPhoto)" class="avatar" />
                </el-upload>
                <!--
              ...
              <li>
                <i class="tit">我的昵称</i><a id="my_name">{{ nickName
              ...
              <li>
                <i class="tit">我的性别</i><a id="my_sex">男<!--<em class="ml10">[修改]</em>--></a>
              </li>
            </ul>
          </div>
        </div>
...
import { getImgVerifyCode, uploadImage } from "@/api/resource";
...
export default {
  ...
  setup() {
    ...
    const getUserImageUrl = (imageUrl) => {
      return getImageUrl(imageUrl, man);
    };
