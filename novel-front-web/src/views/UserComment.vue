      ...
      <div class="my_r">
        <div class="my_bookshelf">
                ...
                <div class="bookComment">
                    <div v-if="comments.length == 0" class="no_contet no_comment" >
                        您还没有发表过评论！
                    </div>
                    <div v-if="comments.length > 0" class="commentBar" id="commentBar">
                      <div v-for="(item, index) in comments"
                  :key="index" class="comment_list cf"><div class="user_heads fl" vals="389"><img :src="getBookImageUrl(item.commentBookPic)" class="user_head" alt="" onerror="this.src='default.gif';this.onerror=null"><span class="user_level1" style="display: none;">见习</span></div><ul class="pl_bar fr">			<li class="name">{{ item.commentBook }}</li><li class="dec" v-html="item.commentContent"></li><li class="other cf"><span class="time fl">{{ item.commentTime }}</span><span class="fr"><a href="javascript:void(0);" onclick="javascript:BookDetail.AddAgreeTotal(77,this);" class="zan" style="display: none;">赞<i class="num">(0)</i></a></span></li>		</ul>	</div>
                    </div>
                </div>
